...
var girl,girlrunning,girlcollided,girlImage,zombie,zombierunning,
    zombieattack;
...
groundimage=loadImage("Background.png");
  girlrunning=loadAnimation("Run (1).png","Run (2).png","Run (3).png","Run (4).png","Run (5).png","Run (6).png","Run (7).png","Run (8).png","Run (9).png","Run (10).png","Run (11).png","Run (12).png","Run (14).png","Run (15).png","Run (16).png","Run (17).png","Run (18).png","Run (19).png","Run (20).png");
  zombierunning=loadAnimation("Walk (1).png","Walk (2).png","Walk (3).png","Walk (4).png","Walk (5).png","Walk (6).png","Walk (7).png","Walk (8).png","Walk (9).png","Walk (10).png");
  zombieattack=loadAnimation("Attack (2).png","Attack (3).png","Attack (4).png","Attack (5).png","Attack (6).png","Attack (7).png","Attack (8).png");
  obstacle1=loadImage("obstacle1.png");
  zombieidle=loadImage("Stand.png");
  jumpSound = loadSound("jump.mp3")
  dieSound = loadSound("die.mp3")
  checkPointSound = loadSound("checkPoint.mp3")
  gameOverImage=loadImage("gameOver1.png");
  restartImage=loadImage("restart1.png");
  girlcollided=loadImage("Dead (30).png");
...
ground.scale=1.4;
  ...
  girl.addImage("girlcollided",girlcollided);
 ...
 // girl.velocityX=2;
  ...
  zombie.addAnimation("zombieattack",zombieattack);
  zombie.addImage("zombieidle",zombieidle);
  zombie.scale=0.2;
  zombie.debug=false;
 // zombie.velocityY=-13;
...
zombie.collide(invisible_ground); 
 ...
 if((keyDown("space")&& girl.y > 410)) {
  ...
  zombie.changeAnimation("zombieattack",zombieattack);
     zombie.x=girl.x;
  if (zombie.isTouching(girl)) {
    girl.changeImage("girlcollided",girlcollided);
    zombie.changeImage("zombieidle",zombieidle);
  }
